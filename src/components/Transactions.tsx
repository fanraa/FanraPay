...
import { Plus, X, ArrowDownRight, ArrowUpRight, Save, Calendar, Tag, FileText, Inbox, Camera, Clock, Info, Trash2, Image as ImageIcon, Search, ArrowUp, Eye, ChevronLeft } from 'lucide-react';
            ...
            <div key={dateStr} className="mb-6 last:mb-2">
              ...
              <div className="divide-y divide-[#F0EFEC]/80">
                {groupedTransactions[dateStr]
                  ...
                  .map((t) => (
                  <div key={t.id} className="relative overflow-hidden -mx-2 rounded-xl group bg-transparent">
